...
namespace ZealandBook.Services.SQLService
{
    public class SQLServiceBooking
    {
        ...
        {
            string query = $"INSERT into Booking(Booking_Id,Date_From,Date_To,Student_Id, Teacher_Id,Room_Id) Values(@Booking_Id,@Date_From,@Date_To,@Student_Id, @Teacher_Id,@Room_Id)";
